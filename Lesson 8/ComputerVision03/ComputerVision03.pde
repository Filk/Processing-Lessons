...
void draw() 
{
  ...
  for (int x = 0; x < video.width; x ++ ) 
  {
    ...
    {
      //this equation runs through all the pixels in the screen (see https://processing.org/tutorials/pixels/)
      ...
      else 
      {
        ...
        pixels[loc] = color(0, 255, 0); // We could choose to replace the background pixels 
