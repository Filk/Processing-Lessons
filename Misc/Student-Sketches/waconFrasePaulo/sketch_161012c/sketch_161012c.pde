...
PFont font;
String letters = "Gosto dos pássaros, do silêncio e da chuva. De palavras que voam";
int fontSizeMin = 3;
...
void setup() {
   ...
   */
       ...
       //Load a soundfile
    soundfile = new SoundFile(this, "escala.aif");
...
void draw() {
  ...
  soundfile.rate(map(mouseX, 0, width, 0, 4.0)); 
